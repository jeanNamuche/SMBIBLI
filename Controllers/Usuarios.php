    ...
    public function validar()
    {
        ...
        if (empty($usuario) || empty($clave)) {
            ...
            if ($data) {
                ...
                $id_user = $data['id'];
                $esAlumno = $this->model->verificarPermisos($id_user, "Alumno");
                if ($esAlumno) {
                    $msg = array('msg' => 'Procesando', 'icono' => 'success', 'redirect' => base_url . 'Catalogo');
                } else {
                    $esAdmin = $this->model->verificarPermisos($id_user, "Usuarios") || $id_user == 1;
                    if ($esAdmin) {
                        $msg = array('msg' => 'Procesando', 'icono' => 'success', 'redirect' => base_url . 'Configuracion/admin');
                    } else {
                        $msg = array('msg' => 'No tienes permisos asignados', 'icono' => 'warning');
                    }
                }
            } else {
