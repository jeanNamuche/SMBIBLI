...
<body class="app sidebar-mini">
    ...
    if (isset($_SESSION['id_usuario'])) {
        // Se asume que existe la función en el modelo para verificar permisos
    ...
    <?php } else { ?>
        ...
        <aside class="app-sidebar">
            ...
            <ul class="app-menu">
                ...
                <li class="treeview"><a class="app-menu__item" href="#" data-toggle="treeview"><i class="app-menu__icon fa fa-list"></i><span class="app-menu__label">Gestión de libros</span><i class="treeview-indicator fa fa-angle-right"></i></a>
